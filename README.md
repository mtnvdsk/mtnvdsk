...
<p>Data Engineer at <a href="https://lloydstechnologycentre.com/">LBG</a><img src="https://media.giphy.com/media/WUlplcMpOCEmTGBtBW/giphy.gif" width="30"> 
</em></p>
...
class profile:
    ...
    def profile(self):
        self.i["am"] = ["Tarun", "Data Engineer"]
        self.i["love"] = ["Machine Learning", "DSA", "Mathematics", "Deep Learning"]
        self.i["work With"] = ["Python", "Java", "AWS", "Docker", "Pyspark", "Linux", "DBT", "Data Governance", "GCP", "c++"]
